...
| `RunSession.Tick`: time → ingest → combat → **take the shot** → **skills** → **timed expiry** → **zones** → enemy behaviours → **projectiles** → (dead? end) → **xp drain** → **director** → **stage flow** → motor → intent | the gun aims at where enemies *were*; the motor turns before it knows its facing | M1-06, M1-08, M2-05, M2-07a, M2-10, M3-01a, M3-06, M3-11a-ii, M3-11b, M5-01 |

...
_Updated: 2026-09-25, as of RS-03c's merge — the Ranger is a fourth class in class select, free, with a nine-node tree. M7's third spec group is written, two to go, nothing of M7 built._

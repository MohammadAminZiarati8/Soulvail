...
_Updated: 2026-09-25, as of RS-02b's merge — a run wears the body its class names, and all three name the Knight. M7's third spec group is written, two to go, nothing of M7 built._

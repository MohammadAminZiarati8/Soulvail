...
_Updated: 2026-09-25, as of RS-00b's merge — the Ranger's class and its three passives specced as RS-02b to RS-03d; M7's specs stand at two groups of five, nothing of M7 built._
...
| **Last merged task** | **RS-00b — specs for the Ranger's class and its three passives.** Six specs: [a body per class](tasks/RS-02b-a-body-per-class.md), [an arrow per shooter](tasks/RS-02c-an-arrow-per-shooter.md), [holding fire on the move](tasks/RS-03a-holding-fire-on-the-move.md), [the volley](tasks/RS-03b-the-volley.md), [the Ranger joins the roster](tasks/RS-03c-the-ranger-joins-the-roster.md) and [the Ranger, seen](tasks/RS-03d-the-ranger-seen.md). Before it, [RS-02a](tasks/RS-02a-a-playable-ranger.md) put a playable Ranger in `RangerShowcase.unity`, shooting only standing still. |
| **Next task** | **RS-02b** (a body per class) and **RS-03a** (holding fire, core), which do not depend on each other. **After the Ranger's kit, the owner designs the second new class.** M7-00c's specs have a PR open. **The `m6` tag is still the owner's.** **Two rulings are the owner's before M7-00e**: where the art comes from and where the audio comes from. |
| **Verified** | **RS-02a: 3 196 EditMode — 3 195 passed / 0 failed / 1 inconclusive — and PlayMode 53 / 0 / 0 on three passes of three**, +36 and +28. The inconclusive row is by construction: one of the two animator clock rows always is, and which one depends on the Editor's clock ([Traps §3](../Traps.md)). **A PlayMode pass also overwrites the real `run.json`** ([parking lot](ROADMAP.md#parking-lot)). The chain of counts is each Log entry's **Verified** line ([M6's](archive/PROGRESS-M6.md)). **The played numbers — hits to kill at seven depths for three classes, bodies, frame times, the economy, the Claiming — are [M6-11's *As built*](tasks/M6-11-acceptance-and-tag.md#as-built).** |

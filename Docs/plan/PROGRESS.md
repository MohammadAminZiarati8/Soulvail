...
_Updated: 2026-09-25, as of M7-00b's merge — M7's second spec group written, three to go; nothing of M7 built._
...
| **Last merged task** | **[M7-00b](ROADMAP.md#m7--content-pass) — specs for the affixes and what a player sees.** Five specs: [the three archetypes drawn](tasks/M7-01d-three-archetypes-a-player-can-read.md), [the affix roll and the three that act while alive](tasks/M7-02c-the-affix-roll.md), [the two that fire on death](tasks/M7-02d-the-two-that-fire-on-death.md), [a second affix, bought](tasks/M7-02f-a-second-affix-bought.md) and [an Elite you can see](tasks/M7-02e-an-elite-you-can-see.md) — the fourth found while counting. |
| **Next task** | **M7-00c** — specs for the Choirmother. **The `m6` tag is still the owner's.** **Two rulings are the owner's before M7-00e**: where the art comes from and where the audio comes from. |
| **Verified** | **Docs only at M7-00b — no C#, no compile, no suite.** The baseline stays **3 160 EditMode — 3 159 passed / 0 failed / 1 inconclusive — and PlayMode 25 / 0 / 0 on ten passes of ten** from M6-11e. The inconclusive row is by construction: one of the two animator clock rows always is, and which one depends on the Editor's clock ([Traps §3](../Traps.md)). **A PlayMode pass also overwrites the real `run.json`** ([parking lot](ROADMAP.md#parking-lot)). The chain of counts is each Log entry's **Verified** line ([M6's](archive/PROGRESS-M6.md)). **The played numbers — hits to kill at seven depths for three classes, bodies, frame times, the economy, the Claiming — are [M6-11's *As built*](tasks/M6-11-acceptance-and-tag.md#as-built).** |

...
**The ten below are titles until 00b–d write them** — no sizes, no dependencies, no boxes, because a size is a claim about a Files table that does not exist yet. What they inherit from 00a is listed in [PROGRESS → Next task](PROGRESS.md#current-state).
